package com.gregchance.exam.controllers;
...
import com.gregchance.exam.models.User;
import com.gregchance.exam.repositories.TaskRepo;
import com.gregchance.exam.repositories.UserRepo;
import com.gregchance.exam.services.UserServ;
import com.gregchance.exam.validator.UserValidator;
...
//	Destroy Task
	...
	public String destroyTask(@PathVariable("task_id") Long taskId) {
